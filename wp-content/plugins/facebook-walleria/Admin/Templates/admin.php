...
<div class="wrap">
    ...
    <div id="icon-plugins" class="icon32"></div><h2><?php echo __('Facebook Walleria', 'facebook-walleria'); ?></h2>
...
<?php require_once ( 'admin-tab-permissions.php'); ?>
            </div>
            <div id="fwpg-appearance">
                <?php require_once ( 'admin-tab-appearance.php'); ?>
            </div>

            <div id="fwpg-animations">
<?php require_once ( 'admin-tab-animations.php'); ?>
            </div>

            <div id="fwpg-behaviour">
<?php require_once ( 'admin-tab-behaviour.php'); ?>
            </div>
            <div id="fwpg-other">
                <?php require_once ( 'admin-tab-other.php'); ?>
            </div>


            <div id="fwpg-support">
<?php require_once ( 'admin-tab-support.php'); ?>
            </div>

            <div id="fwpg-uninstall">
<?php require_once ( 'admin-tab-uninstall.php'); ?>
            </div>
