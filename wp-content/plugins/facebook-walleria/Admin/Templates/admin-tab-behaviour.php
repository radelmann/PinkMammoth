							...
							<td>
								<fieldset>
									...
									<label for="imageScale">
										<input type="checkbox" name="walleria[fwpg_imageScale]" id="imageScale"<?php if (!empty($settings['fwpg_imageScale'])) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="centerOnScroll">
										<input type="checkbox" name="walleria[fwpg_centerOnScroll]" id="centerOnScroll"<?php if (!empty($settings['fwpg_centerOnScroll'])) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnContentClick">
										<input type="checkbox" name="walleria[fwpg_hideOnContentClick]" id="hideOnContentClick"<?php if (!empty($settings['fwpg_hideOnContentClick'])) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnOverlayClick">
										<input type="checkbox" name="walleria[fwpg_hideOnOverlayClick]" id="hideOnOverlayClick"<?php if (!empty($settings['fwpg_hideOnOverlayClick'])) echo ' checked="yes"';?> />
						...
						<tr valign="top">
							...
							<td>
								<fieldset>
									...
									<label for="enableEscapeButton">
										<input type="checkbox" name="walleria[fwpg_enableEscapeButton]" id="enableEscapeButton"<?php if (!empty($settings['fwpg_enableEscapeButton'])) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="cyclic">
										<input type="checkbox" name="walleria[fwpg_cyclic]" id="cyclic"<?php if (!empty($settings['fwpg_cyclic'])) echo ' checked="yes"';?> />
