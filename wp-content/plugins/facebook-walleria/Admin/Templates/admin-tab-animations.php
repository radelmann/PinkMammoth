						...
						<tr valign="top">
							...
							<td>
								<fieldset>
									...
									<label for="Opacity">
										<input type="checkbox" name="walleria[fwpg_Opacity] id="Opacity"<?php if (!empty($settings['fwpg_Opacity'])) echo ' checked="yes"';?> />
										<?php _e('Change content transparency during  animations (default: on)', 'facebook-walleria'); ?>
									</label><br /><br />

									<label for="SpeedIn">
										<select name="walleria[fwpg_SpeedIn]" id="SpeedIn">
											<?php
									...
									<label for="SpeedOut">
										<select name="walleria[fwpg_SpeedOut] id="SpeedOut">
											<?php
											foreach($msArray as $key=> $ms) {
									...
									<label for="SpeedChange">
										<select name="walleria[fwpg_SpeedChange] id="SpeedChange">
											<?php
											foreach($msArray as $key=> $ms) {
