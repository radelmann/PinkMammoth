...
if (!function_exists('theme_get_excerpt')){
	function theme_get_excerpt($args = array()) {
		global $post;
		$more_tag = theme_get_array_value($args, 'more_tag', __('<img src="' . get_bloginfo('template_directory'). '/images/but-send.gif" alt="read more" title="Read more..." />', THEME_NS));
